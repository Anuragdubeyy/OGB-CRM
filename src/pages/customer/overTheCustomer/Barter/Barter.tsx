...
import { barterColumn } from "./column";
...
import {
  getCustomerOtcBarterListAsync,
  selectAllCustomerOtcBarterList,
} from "../../../../store/slices/customerOtcBarter";
import { useEffect } from "react";
import { ImageDomain } from "../../../../constant";

export default function BarterCustomer() {
  const customer = useAppSelector(selectAllCheckUserList);
  const checkUserId = useAppSelector(selectCheckUserId);
  const CustomerOtcList = useAppSelector(selectAllCustomerOtcBarterList);

  const dispatch = useAppDispatch();
  useEffect(() => {
    dispatch(getCustomerOtcBarterListAsync(checkUserId));
