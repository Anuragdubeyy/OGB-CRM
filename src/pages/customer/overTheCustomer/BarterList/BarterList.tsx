...
import { barterListColumn } from "./column";
...
import {
  getCustomerOtcBarterListsAsync,
  selectAllCustomerOtcBarterListList,
} from "../../../../store/slices/customerOtcbarterList";
import { useAppDispatch, useAppSelector } from "../../../../store/Hooks";
import { useEffect } from "react";
import { ImageDomain } from "../../../../constant";

export default function BarterListCustomer() {
  const customer = useAppSelector(selectAllCheckUserList);
  const checkUserId = useAppSelector(selectCheckUserId);
  const CustomerOtcList = useAppSelector(selectAllCustomerOtcBarterListList);

  const dispatch = useAppDispatch();
  useEffect(() => {
    dispatch(getCustomerOtcBarterListsAsync(checkUserId));
