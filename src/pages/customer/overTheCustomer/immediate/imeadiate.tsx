...
import { immediateColumn } from "./column";
...
import {
  getCustomerOtcImmediateSellsAsync,
  selectAllCustomerOtcImmediateSellList,
} from "../../../../store/slices/customerOtcImmediateSell";
import { useEffect } from "react";
import { ImageDomain } from "../../../../constant";

export default function ImmediateSellCustomer() {
  const customer = useAppSelector(selectAllCheckUserList);
  const checkUserId = useAppSelector(selectCheckUserId);
  const CustomerOtcList = useAppSelector(selectAllCustomerOtcImmediateSellList);

  const dispatch = useAppDispatch();
  useEffect(() => {
    dispatch(getCustomerOtcImmediateSellsAsync(checkUserId));
