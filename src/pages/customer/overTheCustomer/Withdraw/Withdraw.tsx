...
import { withdrawColumn } from "./column";
...
import {
  getCustomerOtcWithdrawListAsync,
  selectAllCustomerOtcWithdrawList,
} from "../../../../store/slices/CustomerOtcWithdraw";
import { useEffect } from "react";

export default function Withdraw() {
  const customer = useAppSelector(selectAllCheckUserList);
  const checkUserId = useAppSelector(selectCheckUserId);
  const CustomerOtcList = useAppSelector(selectAllCustomerOtcWithdrawList);
