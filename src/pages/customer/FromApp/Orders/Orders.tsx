...
import { getCustomerOrderListAsync, selectAllCustomerOrderList } from "../../../../store/slices/customerOrder";
...
export default function Orders() {
  ...
  const CustomerOrderList = useAppSelector(selectAllCustomerOrderList);
  const dispatch = useAppDispatch();
  useEffect(() =>{
    dispatch(getCustomerOrderListAsync(checkUserId))
    ...
    <DataTable tableRef={[]} columns={OrderColumn} data={CustomerOrderList}/>
  </div>
