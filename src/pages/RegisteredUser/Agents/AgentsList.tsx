...
import { agentDetailsColumn } from "./column";
...
export default function AgentDetails() {
  ...
  return (
    <section className="border-2 rounded-3xl p-2" style={{borderColor: "rgba(195, 166, 109, 1)"}}>
      <div className="flex justify-between p-2">
        <div>
          <h2 className="font-bold text-black ">Agent Details</h2>
          <p className=" text-black  text-opacity-70">Total Collection Ornament : 9</p>
        </div>
        <div className="flex items-center gap-16">
          <div className="flex items-center border border-input bg-background rounded ring-offset-background">
            <Search className="ml-5 text-gray-500" />
              ...
              <Link to="/add-agent-form"><Button>Add Agents</Button></Link>
  ...
  <DataTable tableRef={tableRef} columns={agentDetailsColumn} data={[]}/>
</div>
